...
@Service
public class ZhongsanStrategy extends BaseStrategy{


    @Override
    public boolean isWin(Object calNo, TCFFCPRIZE realNo) {
        TCFFCPRIZE tcffcprize = (TCFFCPRIZE) calNo;
        return  LotteryUtil.judgeIsmatchBetween4(tcffcprize.getQian(), realNo.getQian())
                &&LotteryUtil.judgeIsmatchBetweenPost4(tcffcprize.getBai(), realNo.getBai())
                &&LotteryUtil.judgeIsmatchBetween4(tcffcprize.getShi(), realNo.getShi());
    }
