...
/*002 001 1
    ...
    private List<String> genetateQian2NumsFromLotteryDetail(LotteryDetail detailDO) {

        String num5 =detailDO.getNum5();
        String num4 =detailDO.getNum4();
    ...
    public String runStaticNumStrategy(String start, String end){
        //批量验证数据
        LotteryDetailCondition lotteryDetailCondition = new LotteryDetailCondition();
        lotteryDetailCondition.setOrderByClause("alias_no asc ");
        ...
        BigDecimal baseAmt = new BigDecimal("0.98");
        BigDecimal baseProfit = new BigDecimal("0.936");
        ...
        LotteryDetail preLotteryDetail;
        for (int i=0;i <list.size();i++ ) {
            LotteryDetail detail = list.get(i);

            if (i == 0) {
                preLotteryDetail = list.get(0);
                continue;
            }
            preLotteryDetail = list.get(i-1);

            String num5 = detail.getNum5();
            String num4 = detail.getNum4();
            int nextNo = 1;
            boolean isPrized = false;
            if (this.genetateQian2NumsFromLotteryDetail(preLotteryDetail).contains(num5+num4)) {
                isPrized = true;
                winCnt++;
            }
        ...
        System.out.println("totalThrow:" + totalThrow + ",totalProfit:" + totalProfit + ", maxProfit:" + maxProfit + ",minProfit:" + minProfit + ",winCnt:" + winCnt + ",totalCnt:" + list.size());
        return  "";
    }
